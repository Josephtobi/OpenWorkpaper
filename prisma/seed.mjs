...
const TEMPLATES = [
        ...
        groups: [
          {
            ...
            procedures: [
              { title: 'Client Acceptance / Continuance Assessment', purpose: 'To assess whether the firm should accept or continue the engagement in accordance with ISQM 1 and ISA 220, including evaluation of client integrity, management character, and any threats to independence.', source: 'ISQM 1; ISA 220.25; ICAN Code of Ethics' },
              { title: 'Independence Assessment — Firm & Engagement Team', purpose: 'To confirm that all engagement team members and the firm are independent of the client in compliance with the ICAN Code of Ethics (IFAC-aligned) and ISA 220.15.', source: 'ISA 220.15; ICAN Code of Ethics Part B; ISQM 1.29' },
              { title: 'Conflict of Interest Review', purpose: 'To identify and document any actual or potential conflicts of interest between the firm, engagement team members, and the client or its related parties.', source: 'ICAN Code of Ethics s.220; ISA 220' },
              { title: 'Engagement Letter — Execution and Filing', purpose: 'To confirm that the terms of the audit engagement have been agreed in writing with management or those charged with governance, in accordance with ISA 210.', source: 'ISA 210.10; CAMA 2020 s.402' },
              { title: 'Management Representation Agreement', purpose: 'To document that management acknowledges its responsibility for the financial statements and for providing the auditor with all relevant information, per ISA 580.', source: 'ISA 580.10' },
              { title: 'Prior Year Audit File Review', purpose: 'To review the prior year audit conclusions, adjusting entries, carry-forward matters, and any unresolved issues that may affect the current year engagement.', source: 'ISA 300.13; ISA 510' },
            ],
          },
          {
            name: 'Understanding the Entity',
            procedures: [
              { title: 'Business Understanding — Industry, Operations & Regulatory Environment', purpose: 'To obtain and document a thorough understanding of the client\'s business, industry dynamics, competitive environment, and applicable regulatory framework, in accordance with ISA 315.11.', source: 'ISA 315.11–315.19' },
              { title: 'Ownership Structure & Related Parties — Identification', purpose: 'To identify all related parties, including ultimate beneficial owners, subsidiaries, associates, and key management personnel, to support related party testing under ISA 550 and IAS 24.', source: 'ISA 550.13; IAS 24' },
              { title: 'Legal & Regulatory Framework Applicable to Client', purpose: 'To document all laws and regulations that have a direct effect on the financial statements, including CAMA 2020, NTA 2025, PENCOM, NSITF, sector-specific regulations, and applicable IFRS standards, per ISA 250.', source: 'ISA 250.13; CAMA 2020; NTA 2025; PENCOM Act 2014; NSITF Act' },
              { title: 'Going Concern Assessment — Preliminary', purpose: 'To perform a preliminary assessment of the entity\'s ability to continue as a going concern for at least 12 months from the reporting date, identifying any indicators of financial distress, per ISA 570.', source: 'ISA 570.10' },
              { title: 'Prior Year Financial Statements & Audit Report Review', purpose: 'To review the prior year signed financial statements and audit report to identify accounting policies, prior year adjustments, emphasis of matter paragraphs, and any matters requiring follow-up in the current year.', source: 'ISA 300.13; ISA 510; IAS 1' },
              { title: 'Key Accounting Policies Assessment', purpose: 'To document and evaluate the appropriateness of the client\'s significant accounting policies under IFRS, including any changes in policy or estimates from the prior year per IAS 8.', source: 'ISA 315.19; IAS 1.117; IAS 8' },
              { title: 'Organisational Structure & IT Environment Overview', purpose: 'To understand the client\'s organisational chart, key personnel, authorisation levels, and IT systems used for financial reporting, as inputs to the risk assessment and internal controls evaluation per ISA 315.', source: 'ISA 315.19; ISA 315.A56' },
            ],
          },
          {
            name: 'Risk Assessment',
            procedures: [
              { title: 'Entity-Level Risk Assessment', purpose: 'To identify and assess risks at the financial statement level that may result from a weak control environment, management override, or pervasive misstatement, per ISA 315.26.', source: 'ISA 315.26' },
              { title: 'Significant Risks Identification — Including Fraud Risks', purpose: 'To identify risks that require special audit consideration, including the presumed fraud risks of management override of controls and improper revenue recognition, per ISA 240 and ISA 315.28.', source: 'ISA 315.28; ISA 240.26' },
              { title: 'Inherent Risk Assessment by Financial Statement Area', purpose: 'To assess the inherent risk of material misstatement at the assertion level for all material account balances and transaction classes, to determine the nature, timing and extent of further audit procedures per ISA 315.', source: 'ISA 315.31' },
              { title: 'Related Party Transactions — Risk Assessment', purpose: 'To assess the risk that related party transactions and balances have not been completely identified, properly authorised, and appropriately disclosed in the financial statements, per ISA 550 and IAS 24.', source: 'ISA 550.13; IAS 24' },
              { title: 'IT Environment & General IT Controls Assessment', purpose: 'To understand and document the client\'s IT general controls (access controls, change management, operations) and assess the risk of material misstatement arising from IT system weaknesses, per ISA 315.', source: 'ISA 315.A56–A67' },
              { title: 'Fraud Risk Assessment — Discussion & Documentation', purpose: 'To conduct and document the engagement team discussion on the susceptibility of the financial statements to material misstatement due to fraud, including identification of fraud risk factors, per ISA 240.15.', source: 'ISA 240.15; ISA 240.26' },
              { title: 'Analytical Procedures — Planning', purpose: 'To apply analytical procedures at the planning stage to identify unusual transactions, balances, or trends that may indicate areas of higher risk requiring focused audit attention, per ISA 520.', source: 'ISA 520.3; ISA 315.6' },
            ],
          },
          {
            name: 'Materiality',
            procedures: [
              { title: 'Overall Materiality Determination', purpose: 'To determine the overall materiality threshold for the financial statements as a whole, based on an appropriate benchmark (PBT, revenue, total assets, or net assets) and the needs of the primary users of the financial statements, per ISA 320.10.', source: 'ISA 320.10; FDC Audit Manual s.3.1' },
              { title: 'Performance Materiality', purpose: 'To set performance materiality at a level below overall materiality to reduce to an appropriately low level the probability that the aggregate of uncorrected and undetected misstatements exceeds overall materiality, per ISA 320.11.', source: 'ISA 320.11' },
              { title: 'Trivial Amount Threshold', purpose: 'To establish the threshold below which identified misstatements will not be accumulated for evaluation, typically set at 5% of overall materiality, per ISA 450.', source: 'ISA 450.A2' },
              { title: 'Specific Materiality for Sensitive Items', purpose: 'To determine whether a lower materiality threshold applies to specific classes of transactions or disclosures — including related party transactions, directors\' remuneration, regulatory compliance items, and any politically sensitive amounts — per ISA 320.10.', source: 'ISA 320.10; CAMA 2020 s.394' },
              { title: 'Materiality Basis Justification & Documentation', purpose: 'To document the rationale for the chosen materiality benchmark, the quantitative threshold selected, and any qualitative factors considered, ensuring the basis is appropriate given the client\'s industry, size, and financial profile per ISA 320.', source: 'ISA 320; ISA 230' },
            ],
          },
          {
            name: 'Audit Strategy & Plan',
            procedures: [
              { title: 'Overall Audit Strategy Document', purpose: 'To establish the overall audit strategy that sets the scope, timing, and direction of the audit, and guides the development of the audit plan, per ISA 300.7.', source: 'ISA 300.7' },
              { title: 'Audit Plan — Scope and Timing by Area', purpose: 'To document the detailed audit plan describing the nature, timing, and extent of planned risk assessment procedures and further audit procedures at the assertion level for each material financial statement area, per ISA 300.9.', source: 'ISA 300.9; ISA 330' },
              { title: 'Engagement Team Briefing Notes', purpose: 'To document the briefing of the engagement team on the client\'s business, significant risks, fraud risks, materiality, key accounting issues, and each team member\'s responsibilities, per ISA 300.11 and ISA 240.15.', source: 'ISA 300.11; ISA 240.15' },
              { title: 'Allocation of Work — Team Assignments', purpose: 'To document the assignment of audit areas to specific team members, including the responsible preparer and reviewer for each section, ensuring appropriate experience levels are matched to risk areas per ISA 220.', source: 'ISA 220.32' },
              { title: 'Use of Specialists — Assessment', purpose: 'To assess whether the engagement requires the use of an auditor\'s expert and to document the basis for any such decision and the planned oversight procedures, per ISA 620.', source: 'ISA 620' },
              { title: 'Engagement Milestone & Deadline Schedule', purpose: 'To establish and document key engagement milestones including fieldwork start and end dates, draft financial statements receipt, management letter issuance, and target audit report signing date, to support timely delivery per ISA 300.', source: 'ISA 300; CAMA 2020 s.374' },
            ],
          },
          {
            name: 'Internal Controls Assessment',
            procedures: [
              { title: 'Control Environment Assessment', purpose: 'To evaluate the overall control environment including management\'s philosophy, organisational structure, assignment of authority, and commitment to competence, as the foundation for assessing control risk across all audit areas, per ISA 315.', source: 'ISA 315.A68' },
              { title: 'Revenue Cycle Controls Walkthrough', purpose: 'To document and evaluate the design and implementation of controls over the revenue cycle, from order/contract initiation through invoicing, cash collection, and ledger posting, to determine whether reliance on controls is appropriate per ISA 330.', source: 'ISA 330.13; ISA 315.26' },
              { title: 'Expenditure Cycle Controls Walkthrough', purpose: 'To document and evaluate the design and implementation of controls over the purchase-to-pay cycle, including procurement authorisation, supplier onboarding, invoice approval, and payment processing, per ISA 330.', source: 'ISA 330.13' },
              { title: 'Payroll Cycle Controls Walkthrough', purpose: 'To document and evaluate controls over the payroll process including new hire authorisation, changes to standing data, payroll computation, PAYE/PENCOM deductions, and bank transfer authorisation, per ISA 330 and ISA 240.', source: 'ISA 330.13; ISA 240; PENCOM Act 2014' },
              { title: 'Cash & Treasury Controls Walkthrough', purpose: 'To document and evaluate controls over cash receipts, cash payments, bank account management, reconciliation procedures, and authorisation of transfers, given the elevated fraud risk associated with cash per ISA 240.', source: 'ISA 330.13; ISA 240' },
              { title: 'IT General Controls (ITGC) Review', purpose: 'To assess the general IT controls environment including logical access controls, user provisioning, change management procedures, and IT operations controls, to determine the reliability of system-generated reports and data per ISA 315.', source: 'ISA 315.A56' },
              { title: 'Control Testing Approach — Reliance Decision', purpose: 'To document the engagement team\'s decision on whether to adopt a controls reliance strategy or a purely substantive approach for each audit area, based on the walkthrough results, efficiency considerations, and assessed control risk per ISA 330.8.', source: 'ISA 330.8' },
            ],
          },
          {
            name: 'PBC Requests & Opening Balances',
            procedures: [
              { title: 'PBC Master List — Issue to Client', purpose: 'To prepare and issue a comprehensive list of all documents, schedules, confirmations, and information required from the client (Provided By Client list) prior to and during fieldwork, ensuring timely receipt of evidence and minimising disruption to client operations.', source: 'ISA 300; ISA 330; FDC Audit Manual' },
              { title: 'Opening Balances Agreement — Prior Year Closing', purpose: 'To confirm that opening balances for the current period correctly reflect the closing balances of the prior period, and that prior year accounting policies have been consistently applied, per ISA 510.', source: 'ISA 510' },
              { title: 'Comparative Figures Review', purpose: 'To confirm that comparative figures presented in the current year financial statements agree to the prior year signed financial statements or have been appropriately restated with adequate disclosure, per IAS 1 and ISA 710.', source: 'ISA 710; IAS 1.38' },
              { title: 'Predecessor Auditor Communication', purpose: 'To document communication with the predecessor auditor (where applicable) to obtain information relevant to the current engagement including prior year working papers access, reasons for change of auditor, and any unresolved matters, per ISA 510 and ICAN ethical requirements.', source: 'ISA 510.6; ICAN Code of Ethics s.320' },
              { title: 'Engagement Progress Tracker — PBC Status', purpose: 'To monitor and document the receipt status of all PBC items throughout the engagement, tracking outstanding items, responsible client personnel, and escalation of overdue requests to engagement management.', source: 'ISA 300; ISA 230' },
            ],
          },
        ],
      },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    definition: 'Substantive procedures for manufacturing clients. Covers revenue (IFRS 15), inventory (IAS 2), PPE (IAS 16), payroll, taxation (NTA 2025), and regulatory compliance (SON, NAFDAC, ITF, NESREA).',
    phases: [
      {
        phase: 'FIELDWORK',
        groups: [
          {
            ...
            procedures: [
              ...
              { title: 'Completeness of Revenue — Cut-Off Testing', purpose: 'To obtain evidence that all revenue transactions relating to the period have been recorded and that no pre or post period revenue has been included, by testing transactions around the reporting date against despatch records, delivery notes, and customer acknowledgements of receipt per ISA 330.', source: 'ISA 330; IFRS 15.31' },
              { title: 'Occurrence — Revenue Transaction Testing', purpose: 'To verify that recorded revenue transactions represent actual sales of goods to legitimate customers during the period, by selecting a sample from the revenue ledger and agreeing to sales invoices, delivery documentation, customer purchase orders, and cash receipts per ISA 330.', source: 'ISA 330' },
          ...
          },
          {
            ...
            procedures: [
              ...
              { title: 'Raw Materials — Purchase Price Variance Analysis', purpose: 'To analyse purchase price variances to identify unusual movements in raw material costs and confirm inventory is recorded at the lower of cost and NRV per IAS 2.', source: 'IAS 2.9' },
          ...
          },
          {
            ...
            procedures: [
              ...
              { title: 'Additions — Capex vs Opex Assessment', purpose: 'To verify that capital additions meet the recognition criteria of IAS 16.7, have been properly authorised, and that expenditure incorrectly capitalised or charged to opex has been identified.', source: 'IAS 16.7' },
              ...
              { title: 'Impairment Assessment (IAS 36)', purpose: 'To assess whether any indicators of impairment exist and, where they do, verify that an impairment test has been performed and any impairment loss correctly recognised and disclosed per IAS 36.', source: 'IAS 36' },
              ...
              { title: 'Right-of-Use Assets (IFRS 16) — Completeness & Calculation', purpose: 'To identify all leases to which IFRS 16 applies, confirm that right-of-use assets and lease liabilities have been recognised for all qualifying leases, and verify the calculation of initial and subsequent measurement.', source: 'IFRS 16' },
            ],
          },
          {
            name: 'Cash and Bank',
            procedures: [
              ...
              { title: 'Bank Confirmation Letters (ISA 505)', purpose: 'To obtain direct confirmation from the client\'s bankers of balances, facilities, and security arrangements at the year-end date per ISA 505.', source: 'ISA 505' },
              ...
              { title: 'Foreign Currency Balances — Translation (IAS 21)', purpose: 'To verify that foreign currency cash and bank balances have been retranslated at the closing exchange rate and that translation gains or losses have been correctly recognised in profit or loss per IAS 21.', source: 'IAS 21' },
            ],
          },
          {
          ...
          },
          {
            ...
            procedures: [
              ...
              { title: 'ITF Levy Compliance', purpose: 'To verify that the Industrial Training Fund levy of 1% of annual payroll has been remitted where applicable (employers with 5 or more employees or N50m+ turnover), and to assess whether the entity qualifies for a refund of up to 50% based on qualifying training expenditure.', source: 'ITF Act 2011' },
          ...
          },
          {
            ...
            procedures: [
              ...
              { title: 'Finance Cost Capitalisation Assessment (IAS 23)', purpose: 'To assess whether any borrowing costs directly attributable to the acquisition or construction of qualifying assets have been capitalised in accordance with IAS 23.', source: 'IAS 23' },
            ],
          },
          {
            name: 'Taxation',
            procedures: [
              ...
              { title: 'Deferred Tax Assessment (IAS 12)', purpose: 'To verify that deferred tax assets and liabilities have been correctly identified, measured, and recognised for all temporary differences between the carrying amounts of assets and liabilities and their tax bases, per IAS 12.', source: 'IAS 12' },
          ...
          },
          {
            ...
            procedures: [
              { title: 'Share Capital Verification (CAMA 2020)', purpose: 'To verify the authorised, issued, and paid-up share capital agrees to the CAC filings, board resolutions, and share register, and complies with minimum capital requirements under CAMA 2020.', source: 'CAMA 2020 s.27' },
          ...
          },
          {
            ...
            procedures: [
              { title: 'Capital Commitments', purpose: 'To obtain details of all capital expenditure contracted for but not yet incurred at the reporting date and confirm adequate disclosure in the financial statements.', source: 'IAS 16; IAS 1.137' },
              ...
              { title: 'Legal Claims and Contingent Liabilities (IAS 37)', purpose: 'To obtain details of all pending or threatened legal claims, tax disputes, and regulatory proceedings, assess the probability of outflow per IAS 37, and confirm that provisions or disclosures are appropriate.', source: 'IAS 37; ISA 501' },
              { title: 'Events After the Reporting Date (IAS 10 / ISA 560)', purpose: 'To identify all adjusting and non-adjusting events after the reporting date through inquiry of management, review of board minutes, and review of subsequent financial information, per IAS 10 and ISA 560.', source: 'ISA 560; IAS 10' },
          ...
          },
          {
            ...
            procedures: [
              { title: 'Segment Reporting Assessment (IFRS 8)', purpose: 'To assess whether the entity meets the thresholds for segment reporting under IFRS 8 and, where applicable, verify the accuracy and completeness of segment information disclosed.', source: 'IFRS 8' },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    definition: 'Substantive procedures for oil and gas service companies. Covers IFRS 6 E&E assets, PPT computation (NTA 2025), NUPRC compliance, ARO decommissioning provisions (IAS 37), NDDC levy, and NOGICD Act local content requirements.',
    phases: [
      {
        phase: 'FIELDWORK',
        groups: [
          {
            ...
            procedures: [
              ...
              { title: 'Foreign Currency Revenue — Translation (IAS 21)', purpose: 'To verify that USD-denominated revenue and receivables are translated at the correct exchange rate per IAS 21, and that translation gains/losses are recognised in profit or loss.', source: 'IAS 21' },
            ],
          },
          {
            ...
            procedures: [
              ...
              { title: 'E&E Impairment Assessment (IFRS 6.18)', purpose: 'To assess whether any triggering events for impairment of E&E assets exist per IFRS 6.20, and where they do, verify that an impairment test has been performed at the appropriate CGU level and any impairment loss correctly recognised.', source: 'IFRS 6.18' },
          ...
          },
          {
            ...
            procedures: [
              { title: 'DD&A — Units of Production Method', purpose: 'To verify that depletion, depreciation, and amortisation for oil and gas assets has been calculated using the units of production method based on proved reserves, and that reserve estimates are adequately supported.', source: 'IAS 16; IFRS 6' },
              ...
              { title: 'Decommissioning Provision — ARO Calculation (IAS 37)', purpose: 'To verify that asset retirement obligations (AROs) have been recognised for all wells and facilities with decommissioning obligations, that the provision is calculated as the present value of expected decommissioning costs per IAS 37, and that the unwinding of discount is recognised as a finance cost.', source: 'IAS 37; IFRIC 1' },
              { title: 'Impairment Testing — CGU Definition (IAS 36)', purpose: 'To confirm that impairment testing has been performed at the appropriate CGU level (typically individual licence area or field) and that value in use calculations are based on supportable reserve estimates and price assumptions per IAS 36.', source: 'IAS 36' },
            ],
          },
          {
            name: 'Taxation — Oil & Gas',
            procedures: [
              { title: 'Petroleum Profits Tax Computation (NTA 2025)', purpose: 'To verify the PPT computation under the applicable provisions of the NTA 2025, including the correct tax rate (65.75% for PSC and JOA, 85% for non-PSC deepwater), allowed deductions, investment tax credit, and any minimum tax provisions.', source: 'NTA 2025; PPTA' },
          ...
          },
          {
            ...
            procedures: [
              { title: 'NUPRC Annual Reports — Filing Status', purpose: 'To confirm that all required annual reports and returns to the Nigerian Upstream Petroleum Regulatory Commission (NUPRC) have been filed within prescribed timelines, and any penalties for late filing are adequately provided for.', source: 'PIA 2021; ISA 250' },
              ...
              { title: 'Local Content Compliance — NOGICD Act', purpose: 'To assess compliance with Nigerian Oil and Gas Industry Content Development (NOGICD) Act requirements including local content targets and NCDMB reporting obligations.', source: 'NOGICD Act 2010; ISA 250' },
              { title: 'NAPIMS Reporting Obligations', purpose: 'To confirm that reporting obligations to NAPIMS have been fulfilled where the entity has NNPCL as a joint venture partner, and that government participation interests are correctly reflected in the accounts.', source: 'PIA 2021' },
            ],
          },
        ],
      },
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    definition: 'Substantive procedures for hotels and restaurants. Covers POS revenue reconciliation, F&B inventory, IFRS 15 loyalty programmes, IFRS 16 leases, and NTDC/state tourism licensing compliance.',
    phases: [
      {
        phase: 'FIELDWORK',
        groups: [
          {
            ...
            procedures: [
              ...
              { title: 'Banqueting and Events Revenue', purpose: 'To verify that revenue from banqueting, conferences, and events is recognised when the event takes place and that deposits received in advance are deferred as contract liabilities per IFRS 15.', source: 'IFRS 15; ISA 330' },
              ...
              { title: 'Third-Party OTA Commission and Net Revenue', purpose: 'To review bookings made through online travel agencies, confirm whether revenue is recognised gross or net per IFRS 15.B34 (principal vs agent), and reconcile OTA commission charges to amounts recorded.', source: 'IFRS 15.B34' },
              { title: 'Cash Revenue Controls and Fraud Risk Assessment', purpose: 'To assess the heightened fraud risk associated with cash revenue in hospitality, review segregation of duties between cashiering and recording functions, and perform directional testing to identify potential understatement of cash sales per 
